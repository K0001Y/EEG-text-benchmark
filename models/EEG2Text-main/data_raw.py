...
def get_input_sample(sent_obj, tokenizer, max_len = 56, add_CLS_token = False, max_spectro_datapoint = 24000):
    ...
    def get_sent_eeg(sent_obj):
        ...
        pad_length = max_spectro_datapoint - sent_eeg_embedding.shape[1]
        sent_eeg_embedding = np.pad(sent_eeg_embedding, ((0, 0), (0, pad_length)), mode='constant', constant_values=0)
        #print(sent_eeg_embedding.shape)

        assert sent_eeg_embedding.shape[0] == 105
        assert sent_eeg_embedding.shape[1] == 24000
