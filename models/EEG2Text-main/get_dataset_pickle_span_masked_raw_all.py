...
from data_span_masked_raw_all import ZuCo_dataset
...
if __name__ == '__main__':
    ...
    with open("train_set_span_masked_raw_all.pkl", "wb") as f:
        pickle.dump(train_set, f)
    with open("dev_set_span_masked_raw_all.pkl", "wb") as f:
        pickle.dump(dev_set, f)
    with open("test_set_span_masked_raw_all.pkl", "wb") as f:
