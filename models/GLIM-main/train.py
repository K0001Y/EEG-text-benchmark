...
# 设备配置：默认使用单卡（适配本地 RTX 4070）
# 如需多卡训练，请修改 --devices 参数，例如服务器上可用: --devices 0 1 2 3 4 5 6 7
parser = argparse.ArgumentParser(description="GLIM Training")
parser.add_argument("--devices", nargs="+", type=int, default=[0],
                    help="GPU device IDs. Default: [0] (单卡). 多卡示例: --devices 0 1 2 3")
parser.add_argument("--precision", type=str, default="bf16-mixed",
                    choices=["32", "16-mixed", "bf16-mixed"],
                    help="训练精度. RTX 4070 支持 bf16-mixed.")
parser.add_argument("--bsz-train", type=int, default=72, help="训练 batch 大小")
...
trainer = L.Trainer(accelerator = 'gpu',
                    ...
                    logger = logger,
                    max_epochs = 200,
                    precision = args.precision,  # RTX 4070 支持 bf16-mixed
