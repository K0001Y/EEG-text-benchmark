...
Usage:
    python -m benchmark_eval.scripts.local_test --step all
    python -m benchmark_eval.scripts.local_test --step build_data
    python -m benchmark_eval.scripts.local_test --step validate
    python -m benchmark_eval.scripts.local_test --step eval_dummy
"""
